...
// prohibited.
//
//  ConnectCustomEvent.h
//  Connect
//
//  Created by Omar Hernandez on 4/25/24.
//

/*!
 @file ConnectCustomEvent.h
 @brief Header file defining all manual API calls that can be made to the Connect library
 @copyright Acoustic, L.P. 2024
 */
 ...
 */
@interface ConnectCustomEvent : NSObject

/*!
 @brief Returns the singleton custom event logger.
 @discussion The ConnectCustomEvent singleton reference.
 @return  ConnectCustomEvent Returns the singleton custom event logger, used for custom event logging.
 */
...
/*!
 ...
 @return BOOL Whether the message was successfully logged or not
 */
- (BOOL)logNSErrorEvent:(NSError *)error message:(NSString *)message level:(kConnectMonitoringLevelType)level;
...
/*!
 ...
 @return BOOL Whether the message was successfully logged or not
 */
- (BOOL)logNSErrorEvent:(NSError *)error message:(NSString *)message file:(const char *)file line:(unsigned int)line level:(kConnectMonitoringLevelType)level;
...
/*!
 ...
 @return BOOL If the event was successfully logged or not.
 */
-(BOOL)logLocationUpdateEventWithLatitude:(double)lat longitude:(double)lng level:(kConnectMonitoringLevelType)level;
...
/*!
 ...
 @param screenViewType - valid values are ConnectScreenViewTypeLoad or ConnectScreenViewTypeUnload; Must not be empty.
