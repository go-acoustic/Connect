...
//#import <TealeafReactNative/TLFApplicationHelper.h>
//#else
 ...
 */
- (BOOL) isConnectHybridBridgeRequest:(NSURLRequest*)request webView:(id)webView;
 ...
 */
- (BOOL) InjectConnectHybridBridgeOnWebViewDidFinishLoad:(id)webView;
